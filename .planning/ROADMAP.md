...
- [ ] **Phase 22: Retire the Legacy Device Model** - The legacy Device(BaseModel) is gone; Rig.devices is typed against the Protocol end-to-end
...
| 22. Retire the Legacy Device Model | v1.4 | 0/? | Not started | - |
